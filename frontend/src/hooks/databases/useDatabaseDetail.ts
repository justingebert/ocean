...
import { InvitationClient } from "@/api/invitationClient.ts";
import { RoleClient } from "@/api/roleClient.ts";
import { UserClient } from "@/api/userClient.ts";
import { Database } from "@/types/database.ts";
import { Invitation, UpstreamCreateInvitationProperties } from "@/types/invitation.ts";
...
export function useDatabaseDetail(databaseId: number, options: UseDatabaseDetailOptions = {}) {
  ...
  const invitedUsers = User.getInvitedUsers(otherUsers, invitations);
